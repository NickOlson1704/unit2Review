...
const allCaps = str2.toLocaleUpperCase()
console.log(allCaps)
...
//replace all
let newStr = "I love to eut upples and bununus".replaceAll(`a`,`u`)
console.log(newStr)
// *** Problem 2 ***
...
const threat = "Mynumber" + num + "'s named \"" + first + "" + last + "\": and you don't " + phrase + "!"
