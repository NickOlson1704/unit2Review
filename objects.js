...
const {name, age: years} = person4

//const name = person4.name
//const years = person4.age
...
const hasWar  = person5.hasOutstandingWarrants
console.log(hasWar)
...
person5.siblings.push("Hector")

person5.possessionCategories[0].category = 'bum resters'
