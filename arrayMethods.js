...
let arrOddNum = arrNum.filter((elementNum) => {
    return elementNum % 2 === 1
})
...
let arrOddNum2 = arrOddNum,filter((element, index) => {
    return arrOddNum2 % 2 === 1 && i % 2 === 1
})

console.log(arrOddNum2)
...
const r1Results = reduce1.reduce((acc, curVal) => {
    return acc + curVal
})
...
const r2Results = reduce1.reduce((acc, curVal) => {
    return acc + curVal
}, 100)
